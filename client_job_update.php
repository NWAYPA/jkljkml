...
<?php
	$job_title = "";
	$job_details = "";
	$query = "SELECT * FROM client_job_posting WHERE client_job_posting.client_id = {$profile_id} AND client_job_posting.c_token = '{$token}' ";
...
<body>
	...
	<nav class="navbar navbar-expand-lg navbar-dark" style="background-color: #292b2c;">
		<a class="navbar-brand" style="color: teal; font-weight: bold;" href=""><img src="images/.jpg" alt="" style="border-radius: 5px; margin-bottom: -15px;"> Posted Job Update <br> <span style="font-size: 15px; margin-left: 30px;">( INIESTA )</span></a>
			...
			<div class="tab-pane fade show active col-md-6" id="Title" role="tabpanel" aria-labelledby="expertise-tab">
				<div class="card" style="text-align: left;">
					...
					<div class="card-body">
						...
						<input type="text" class="form-control" value="<?php echo $job_title; ?>" placeholder="Enter name here" name="project_name">
						<p class="card-text"><b>Name of the Company</b></p>
						<input type="text" value="<?php echo $company_name; ?>" class="form-control" placeholder="Enter Comapny name" name="company_name">
						<br>
						<p class="card-text"><select class="custom-select" name="select1" id="" ?>
								<option value="<?php echo $job_category; ?>">You Selected: <?php echo $job_category; ?></option>
			...
			<div class="tab-pane fade col-md-6" id="Description" role="tabpanel" aria-labelledby="expertise-level-tab">
				<div class="card" style="text-align: left;">
					...
					<div class="card-body">
						...
						<textarea name="job_description" id="" cols="30" rows="5" class="form-control"><?php echo $job_description; ?></textarea>
						<div style="text-align: right; padding-top: 3%;">
				...
				<div class="card" style="text-align: left;">
					...
					<div class="card-body">
						...
						<p class="card-text">
							...
							<select name="job_details" id="" class="form-control">
								<option value="<?php echo $job_details; ?>">You Selected: <?php echo $job_details; ?></option>
			...
			<div class="tab-pane fade col-md-6" id="Expertize" role="tabpanel" aria-labelledby="employment-tab">
				<div class="card" style="text-align: left;">
					...
					<div class="card-body">
						...
						<textarea name="skills_required" id="" cols="30" rows="5" class="form-control"><?php echo $skills; ?></textarea>
						<div style="text-align: right; padding-top: 3%;">
			...
			<div class="tab-pane fade col-md-6" id="Visibility" role="tabpanel" aria-labelledby="languages-tab">
				<div class="card" style="text-align: left;">
					...
					<div class="card-body">
						...
						<select name="job_vacancy" id="" class="form-control">
							<option value='<?php echo $job_vacancy; ?>'>You Selected: <?php echo $job_vacancy; ?></option>
					...
					<div class="card-body">
						...
						<p class="card-text"><b>How would you like to pay your freelancer or agency?</b>
							<select name="pay" id="" class="form-control">
								<option value="<?php echo $pay_like; ?>">You Selected: <?php echo $pay_like;?></option>
								<option value="Pay-By-the-Hour">Pay by the hour</option>
								<option value="Pay-By-Fixed-Price">Pay a fixed price</option>
							</select>
						</p>
						<p class="card-text"><b>What level of experience should your freelancer have?</b>
							<select name="experience" id="" class="form-control">
								<option value="<?php echo $experience; ?>">You Selected: <?php echo $experience; ?> </option>
						...
						<p class="card-text"><b>How long do you expect this project to last?</b>
							<select name="project_time" id="" class="form-control">
								<option value="<?php echo $project_time; ?>">You Selected: <?php echo $project_time; ?></option>
