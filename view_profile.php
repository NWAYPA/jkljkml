...
<body>
	...
	<nav class="navbar navbar-expand-lg navbar-dark" style="background-color: #292b2c;">
		<a class="navbar-brand" style="color: teal; font-weight: bold;" href="view_profile.php"><img src="images/.jpg" alt="" style="border-radius: 5px; margin-bottom: -12px;"> Update Profile <br> <span style="font-size: 15px; margin-left: 40px;"></span> </a>
								...
								<li>
									...
									<div class="row">
										<div class="col-md-5 col-5">
											...
											<strong class="margin-10px-left text-yellow"> personal information : </strong>
