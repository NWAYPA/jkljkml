<nav class="navbar navbar-expand-lg navbar-dark" style="background-color: #292b2c;">
		<a class="navbar-brand" style="color: teal; font-weight: bold;" href="my-hires.php"><img src="images/.jpg" alt="" style="border-radius: 5px; margin-bottom: -15px;"> Update Profile <br> <span style="font-size: 15px; margin-left: 30px;">( INIESTA )</span></a>
