...
<body class="create-your-profile-body">
	...
	<form action="" method="post" enctype="multipart/form-data">
		...
		<nav class="navbar navbar-expand-lg navbar-dark" style="background-color: #292b2c;">
			<a class="navbar-brand" style="color: teal; font-weight: bold;" href="my-hires.php"><img src="images/.jpg" alt="" style="border-radius: 5px; margin-bottom: -15px;"> Profile Build Up <br> <span style="font-size: 15px; margin-left: 30px;"></span></a>
		...
		<ul id="myTab" class="nav nav-tabs justify-content-center">
			...
			<li class="nav-item">
				<a id="2a" href="#Education" class="nav-link" data-toggle="tab" role="tab" aria-controls="personal information" aria-selected="true">personal information</a>
			</li>
			<li class="nav-item">
				...
				<div class="card" style="text-align: left;">
					...
					<div class="card-body">
						...
						<div style="text-align: right;">
							...
							<span>Enter At least one skill</span>
						</div>
			...
			<div class="tab-pane fade col-md-6" id="Education" role="tabpanel" aria-labelledby="education-tab">
				<div class="card" style="text-align: left;">
					...
					<div class="card-body">
						...
						<p class="card-text">
							<b>firstname</b>
							<input type="text" class="form-control" placeholder="ex :boumekhiet" name="ex : salah" required>
						</p>

						<p>
							<b>lastname</b>
							<input type="text" class="form-control" placeholder="ex: salah" name="ex: salah" required>
						</p>

						<p>
							<b>place of birth</b>
							<input type="text" class="form-control" placeholder="algeria" name="algeria" required>
						</p>
						<p>
						...
						<div id="languages-column">
							<div class='input-group'>
								<select class='form-control' name="other_lang" required>
									...
									<option value='punjabi'>ENGLISH</option>
									<option value='bengoli'>FRENCH</option>
								</select>
						...
						<p class="card-text">
							<div class="input-group mb-3">
								<div class="input-group-prepend">
									<span class="input-group-text" id="basic-addon1">+213</span>
								</div>
